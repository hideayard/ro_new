 ...
 * @var app\models\NotifSearch $searchModel
 */
                ...
                'buttons' => [
                    'view' => function ($url, $model) {
                        return Html::a(
                            ...
                            Yii::$app->urlManager->createUrl(['notif/view', 'id' => $model->notif_id, 'view' => 't']),
                    ...
                    'update' => function ($url, $model) {
                        return Html::a(
                            ...
                            Yii::$app->urlManager->createUrl(['notif/update', 'id' => $model->notif_id, 'edit' => 't']),
                    ...
                    'delete' => function ($url, $model) {
                        return Html::a(
                            ...
                            Yii::$app->urlManager->createUrl(['notif/delete', 'id' => $model->notif_id, 'delete' => 't']),
